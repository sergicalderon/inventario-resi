...
begin
  ...
  perform public.log_activity_event(new.organization_id, activity_action, 'supplier', new.id, new.name);
...
begin
  ...
  base_action := case when tg_op = 'INSERT' then tg_argv[1] else tg_argv[2] end;
